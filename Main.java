...
public class Main {
    public static void main(String[] args){
        ...
        while (!com.equals("exit")) {
            ...
            if (s[0].equals("open")) {
                if(s.length<2) {
                    System.out.println("Please write the name of the file to open");
                    continue;
                }
            ...
            if(fileOpened) {
                ...
                if(s[0].equals("saveas")){
                    if(s.length<2) {
                        System.out.println("Please write the name of the file to save to");
                        continue;
                    }
                ...
                if(s[0].equals("create")){
                    ...
                    System.out.println("Please keep in mind, for a stroke to be added you should specify its width as well");
                ...
                if(s[0].equals("erase")){
                    if(s.length<2) {
                        System.out.println("Please write the number of figure to erase");
                        continue;
                    }
                ...
                if(s[0].equals("translate")){
                    if(s.length>=4){
                        ...
                        System.out.println("Please write how do you want to translate the figure(s)");
                        continue;
                    }
                }
                if(s[0].equals("within")){
                    if(s.length>4)
                        ...
                        System.out.println("Please write the type of the figure and its coordinates");
                        continue;
                    }
                }
            }
